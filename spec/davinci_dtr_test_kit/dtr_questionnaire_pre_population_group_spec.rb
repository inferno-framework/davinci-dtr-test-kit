RSpec.describe DaVinciDTRTestKit::DTRQuestionnairePrePopulationGroup do
  ...
  let(:group) { Inferno::Repositories::TestGroups.new.find('dtr_questionnaire_pre_population') }
