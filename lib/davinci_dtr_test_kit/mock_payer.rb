module DaVinciDTRTestKit
  module MockPayer
    ...
    def questionnaire_package_response(request, _test = nil, _test_result = nil)
      ...
      request.response_body = <<-JSON
      {
        "resourceType" : "Parameters",
        "id" : "QuestionnairePackageOutputParamsExample",
        "meta" : {
        ...
        "parameter" : [{
          ...
          "resource" : {
            "resourceType" : "Bundle",
            "id" : "home-o2-questionnairepackage-bundle",
            "meta" : {
              "profile" : ["http://hl7.org/fhir/us/davinci-dtr/StructureDefinition/DTR-QPackageBundle"]
            },
            "type" : "collection",
            "entry" : [{
              "fullUrl" : "http://example.org/home-o2-questionnairepackage",
              "resource" : {
