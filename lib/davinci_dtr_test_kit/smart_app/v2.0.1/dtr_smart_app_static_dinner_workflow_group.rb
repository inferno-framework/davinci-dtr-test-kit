...
require_relative 'tests/dtr_smart_app_prepopulation_attestation_test'
require_relative 'tests/dtr_smart_app_prepopulation_override_attestation_test'
require_relative '../../full_ehr/v2.0.1/static_dinner/dtr_static_dinner_enabled_questions_attestation_test'
