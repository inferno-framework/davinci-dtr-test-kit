...
require_relative '../../../full_ehr/v2.0.1/shared/dtr_custom_questionnaire_package_validation_test'
require_relative '../../../full_ehr/v2.0.1/shared/dtr_custom_questionnaire_libraries_test'
require_relative '../../../full_ehr/v2.0.1/shared/dtr_custom_questionnaire_extensions_test'
require_relative '../../../full_ehr/v2.0.1/shared/dtr_custom_questionnaire_expressions_test'
require_relative '../../../full_ehr/v2.0.1/adaptive_custom/dtr_custom_next_question_response_validation_test'
require_relative '../../../full_ehr/v2.0.1/shared/dtr_prepopulation_attestation_test'
require_relative '../../../full_ehr/v2.0.1/shared/dtr_prepopulation_override_attestation_test'
require_relative '../tests/dtr_smart_app_saving_questionnaire_response_group'
require_relative '../../../full_ehr/v2.0.1/shared/dtr_questionnaire_response_prepopulation_test'
...
module DaVinciDTRTestKit
  class DTRSmartAppCustomAdaptiveWorkflowGroup < Inferno::TestGroup
    ...
    group do
      ...
      # Test 8: verify the custom response has the necessary extensions for pre-population
      test from: :dtr_custom_questionnaire_extensions do
        title %(
          Custom Questionnaires for $next-question Responses contain extensions
      ...
      test from: :dtr_custom_questionnaire_expressions do
        title %(
          Custom Questionnaires for $next-question Responses contain items with
