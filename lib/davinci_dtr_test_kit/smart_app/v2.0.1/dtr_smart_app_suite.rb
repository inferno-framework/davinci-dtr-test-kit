# require_relative 'oauth2_authentication_group'
require_relative 'dtr_smart_app_respiratory_workflow_group'
require_relative 'dtr_smart_app_static_dinner_workflow_group'
require_relative 'adaptive_dinner/dtr_smart_app_adaptive_dinner_workflow_group'
require_relative 'dtr_smart_app_custom_static_workflow_group'
require_relative 'adaptive_custom/dtr_smart_app_custom_adaptive_workflow_group'
require_relative 'dtr_smart_app_questionnaire_must_support_group'
...
require_relative '../endpoints/mock_payer/smart_app_questionnaire_package_endpoint'
require_relative '../endpoints/mock_payer/smart_app_next_question_endpoint'
...
module DaVinciDTRTestKit
  class DTRSmartAppSuite < Inferno::TestSuite
    ...
    # Payer
    suite_endpoint :post, QUESTIONNAIRE_PACKAGE_PATH, MockPayer::SMARTAppQuestionnairePackageEndpoint
    suite_endpoint :post, NEXT_PATH, MockPayer::SMARTAppNextQuestionEndpoint
