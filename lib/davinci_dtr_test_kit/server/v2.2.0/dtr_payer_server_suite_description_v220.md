...
systems to the STU 2.2.0 version of the HL7® FHIR®
...
DTR [requirements](https://hl7.org/fhir/us/davinci-dtr/2.2.0/en/specification.html#defining-questionnaires)
around standard questionnaires, adaptive questionnaires, or both.

******** CURRENTLY THERE IS NO VALIDATION, ONLY A CLIENT SIMUATION   ********
...
that they need in order to implement their forms. The DTR IG does [require that](https://hl7.org/fhir/us/davinci-dtr/2.2.0/en/specification.html#pre-population)
