...
module DaVinciDTRTestKit
  class DTRSmartAppCustomAdaptiveQuestionnaireWorkflowGroup < Inferno::TestGroup
    ...
    description %(
      ...
      2-3 `$next-question` requests. As a part of this workflow, the SMART App system must demonstrate its ability to:
    ...
    group do
      ...
      test from: :dtr_smart_app_adaptive_questionnaire_request do
        description %(
    ...
    group do
      id :dtr_smart_app_custom_adaptive_followup_questions
    ...
    group do
      id :dtr_smart_app_custom_adaptive_followup_questions_2
    ...
    group do
      id :dtr_smart_app_custom_adaptive_completion
