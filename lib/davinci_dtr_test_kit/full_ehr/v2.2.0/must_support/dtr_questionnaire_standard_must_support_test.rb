...
module DaVinciDTRTestKit
  class DTRFullEHRV220QuestionnaireStandardMustSupportTest < Inferno::Test
    include QuestionnaireHelper

    MUST_SUPPORT_METADATA = GeneratedProfileMetadata.for('v2.2.0', 'dtr_std_questionnaire')

    id :dtr_full_ehr_v220_questionnaire_standard_must_support
    title 'Client supports standard Questionnaire must support elements and extensions'
    description %(
      ...
      ave been observed across all completed standard Questionnaires during previous tests.
      ...
      profile. Note that standard Questionnaires from test scenarios where the Questionnaire
    ...
    run do
      ...
      skip_if questionnaires.blank?, 'No standard Questionnaires found to evaluate.'
