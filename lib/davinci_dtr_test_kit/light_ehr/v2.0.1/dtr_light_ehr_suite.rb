...
require_relative '../dtr_light_ehr_options'
...
require_relative '../endpoints/light_ehr_supported_payer_endpoint'
  ...
  class DTRLightEHRSuite < Inferno::TestSuite
    ...
    group do
      ...
      group from: :smart_discovery_stu2 do
        required_suite_options DTRLightEHROptions::SMART_2_REQUIREMENT
        run_as_group
