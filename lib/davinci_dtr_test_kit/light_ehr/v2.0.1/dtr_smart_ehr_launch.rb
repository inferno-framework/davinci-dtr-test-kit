require_relative 'smart_ehr_launch/fhir_launch_context_test'
require_relative 'smart_ehr_launch/fhir_context_coverage_test'
require_relative 'smart_ehr_launch/fhir_context_references_test'
